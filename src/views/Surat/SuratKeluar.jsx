...
import { getAllSuratKeluar, deleteSuratKeluar } from '../../services/AdministrasiAPI';
import ExportExcelButton from 'component/Reporting/ExportSuratKeluar';
import ModalSuratKeluar from 'component/Modal/SuratKeluar';
...
const SuratKeluar = () => {
  ...
  const fetchSurat = async () => {
    try {
      const res = await getAllSuratKeluar();
      ...
      Swal.fire({
        icon: 'error',
        title: 'Gagal',
        text: 'Tidak dapat memuat data surat keluar!',
        timer: 1800,
  ...
  const handleDelete = async (id_surat) => {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        try {
          await deleteSuratKeluar(id_surat);
          Swal.fire({
            icon: 'success',
            title: 'Berhasil',
  ...
  const handleNavigate = (value) => {
    if (value === 'surat-masuk') navigate('/surat-masuk');
    handleMenuClose();
  };
          ...
          <Card>
            ...
            <CardContent>
              <Box display="flex" alignItems="center" justifyContent="space-between" mb={2}>
                <Box display="flex" alignItems="center" gap={1}>
                  ...
                  <Menu anchorEl={anchorEl} open={isMenuOpen} onClose={handleMenuClose}>
                    <MenuItem onClick={() => handleNavigate('surat-masuk')}>📥 Data Surat Masuk</MenuItem>
                    <MenuItem disabled>
                  ...
                  <ExportExcelButton data={surat} fileName="Data_Surat_Keluar" />
                </Box>
              ...
              <Typography variant="body2" color="text.secondary" mb={2}>
                Daftar arsip surat keluar. Klik ikon untuk melihat file, edit, atau hapus. Gunakan tombol Surat Keluar untuk menambah data
                baru.
              </Typography>
...
const TableRowSuratKeluar = ({ data, order, onEdit, onDelete }) => {
  const { id_surat, no_surat, tujuan, tanggal, perihal, file } = data || {};
