...
import {
  createNewSuratKeluar,
  editSuratKeluar,
} from "../../services/AdministrasiAPI";

const ModalSuratKeluar = ({ isOpen, onClose, onSuccess, editData }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (editData) {
        await editSuratKeluar(editData.id_surat, formData);
        Swal.fire({
          icon: "success",
          title: "Berhasil",
        ...
        await createNewSuratKeluar(formData);
        Swal.fire({
          icon: "success",
          title: "Berhasil",
      ...
      console.error("Error submit surat keluar:", error);
          ...
          <Box>
            ...
            {editData && form.fileLama && (
              ...
              >
                File sebelumnya:{" "}
                <a
                  href={`https://webarsipbbpks.online/uploads/${form.fileLama}`}
                  target="_blank"
                  rel="noreferrer"
